...
class HrLoanAcc(models.Model):
    ...
    def _get_default_emp_account(self):
        return int(self.env['ir.config_parameter'].sudo().get_param('loan_accounting.loan_emp_account_id')) or False

    def _get_default_treasury_account(self):
        return int(self.env['ir.config_parameter'].sudo().get_param('loan_accounting.loan_treasury_account_id')) or False

    def _get_default_journal(self):
        return int(self.env['ir.config_parameter'].sudo().get_param('loan_accounting.loan_journal_id')) or False
