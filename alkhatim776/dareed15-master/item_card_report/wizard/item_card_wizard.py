...
class ItemCardWizard(models.TransientModel):
    ...
    def view_report(self):
        ...
        without_cost_tree_view_id = self.env.ref('item_card_report.view_item_card_without_cost_tree').id
        without_cost_location_tree_view_id = self.env.ref('item_card_report.view_item_card_without_cost_loc_tree').id
        without_cost_warehouse_tree_view_id = self.env.ref('item_card_report.view_item_card_without_cost_wh_tree').id

        cost_tree_view_id = self.env.ref('item_card_report.view_item_card_with_cost_tree').id
        cost_location_tree_view_id = self.env.ref('item_card_report.view_item_card_with_cost_loc_tree').id
        cost_warehouse_tree_view_id = self.env.ref('item_card_report.view_item_card_with_cost_wh_tree').id

        without_cost_pivot_view_id = self.env.ref('item_card_report.view_item_card_without_cost_pivot').id
        without_cost_location_pivot_view_id = self.env.ref(
            'item_card_report.view_item_card_without_cost_loc_pivot').id
        without_cost_warehouse_pivot_view_id = self.env.ref(
            'item_card_report.view_item_card_without_cost_wh_pivot').id

        cost_pivot_view_id = self.env.ref('item_card_report.view_item_card_with_cost_pivot').id
        cost_location_pivot_view_id = self.env.ref('item_card_report.view_item_card_with_cost_loc_pivot').id
        cost_warehouse_pivot_view_id = self.env.ref('item_card_report.view_item_card_with_cost_wh_pivot').id
