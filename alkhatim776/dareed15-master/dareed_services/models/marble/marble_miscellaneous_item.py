...
class MarbleCleaningMiscellaneous(models.Model):
    _name = "marble.cleaning.miscellaneous"

    # Main Data
    name = fields.Many2one('product.product', string="Service Item:", domain="[('is_marble', '=', True)]",
                           required=True)
