...
class MiscCleaningMiscellaneous(models.Model):
    _name = "misc.cleaning.miscellaneous"

    # Main Data
    name = fields.Many2one('product.product', string="Service Item:", domain="[('is_cleaning_misc', '=', True)]",
                           required=True)
