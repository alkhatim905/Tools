...
class StockHanger(models.Model):
    _name = "stock.hanger"

    name = fields.Char('hanger')
...
class StockScrap(models.Model):
    ...
    hanger_id = fields.Many2one('stock.hanger','Day')
    death_cases = fields.Selection([
        ('execution', 'Execution'),
        ('daily dead', 'Chicken dead'),
        ('road_dead', 'Road dead'),
        ('harvest_dead', 'Harvest dead'),
        ('sort_dead', 'Sort dead'),
       ], string='Death Cases', default='dead')
